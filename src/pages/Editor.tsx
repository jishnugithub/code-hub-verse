...
const Editor = () => {
  ...
  const [code, setCode] = useState(`// Welcome to CodeShare Hub Editor!
// Start coding your snippet here...
        ...
        <div className="grid gap-6 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1 space-y-6">
            <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-white text-lg">Snippet Details</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex space-x-2">
                    ...
                    />
                    <Button size="sm" onClick={addTag} className="bg-white/10 hover:bg-white/20">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex space-x-2">
                    <Button
                      ...
                      className={isPublic ? "bg-gradient-to-r from-purple-500 to-blue-500" : "bg-white/5 border-white/20 text-white"}
                    >
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
              <CardContent className="p-0">
                <div className="bg-gray-900 rounded-t-lg p-4 border-b border-white/20">
                  <div className="flex items-center space-x-2 text-sm text-gray-400">
                    <div className="w-3 h-3 bg-red-500 rounded-full"></div>
                    <div className="w-3 h-3 bg-yellow-500 rounded-full"></div>
                    <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                    <span className="ml-4">{language}.{language === 'javascript' ? 'js' : language === 'typescript' ? 'ts' : 'py'}</span>
                  </div>
                </div>
                <div className="relative">
                  <Textarea
                    ...
                    className="min-h-[400px] bg-gray-900 border-0 text-white font-mono text-sm resize-none rounded-none rounded-b-lg focus:ring-0 focus:border-0"
